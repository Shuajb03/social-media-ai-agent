...
export const journalPosts: JournalPost[] = [
  ...
  },
  {
    ...
    title: "Three Ways to Wear the Chapter I Overcoat",
    excerpt: "One coat, three completely different rooms to walk into.",
    category: "Fashion Storytelling",
    readTime: "3 min read",
    date: "2026-04-22",
    pattern: "weave",
    tone: "ink",
    body: [
      "The Chapter I Wool Overcoat was built to do more than one job. Here are three ways we wear it.",
      "The Boardroom: Layer it over the Founder's Cable Crewneck and Tailored Wool Trouser. Let the coat be the loudest thing in the room by being the quietest.",
      "The Weekend: Archive Denim, a Crown Tee, and the coat left open. Structured on top, relaxed underneath — that contrast is the whole outfit.",
