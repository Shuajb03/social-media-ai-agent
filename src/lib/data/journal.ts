...
export const journalPosts: JournalPost[] = [
  ...
  {
    slug: "why-chapter-i-starts-small",
    title: "Why Chapter I Starts Small",
    excerpt: "A few pieces, done right, beats twenty done fast.",
    category: "Brand Lore",
    readTime: "3 min read",
    date: "2026-04-22",
    pattern: "weave",
    tone: "ink",
    body: [
      "Most new brands try to launch with a full wardrobe on day one — outerwear, knitwear, accessories, everything at once. We're doing the opposite.",
      "Chapter I is a small, deliberate release built around sportswear essentials — the pieces people actually reach for first. Fewer categories, done properly, before we touch a second one.",
      "That's not a limitation. It's the whole philosophy — quality over volume — applied to the range itself, not just to how each piece is made.",
      "Future chapters will expand the archive. This one is about getting the foundation right.",
    ],
  },
  {
